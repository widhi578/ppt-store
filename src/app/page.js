...
export default function Home() {
  return <><StoreHeader /><main>
    ...
    <section id="template" className="featured section-wrap"><div className="section-heading"><div><p className="eyebrow">PALING DISUKAI</p><h2>Template yang siap<br /><em>mencuri perhatian.</em></h2></div><span className="count-pill">Katalog live via API</span></div><TemplateCatalog /></section>
